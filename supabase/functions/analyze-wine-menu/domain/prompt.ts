...
export function buildSystemPrompt(requestBody: AnalyzeWineMenuRequest): string {
  ...
  return [
    ...
    "Set summary.headline to a concise menu snapshot sentence highlighting the overall list quality, strongest value areas, standout regions/styles, pricing patterns, or notable weaknesses. Do not repeat or directly reference the top pick.",
