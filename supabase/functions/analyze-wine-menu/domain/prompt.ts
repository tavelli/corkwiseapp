...
export function buildSystemPrompt(requestBody: AnalyzeWineMenuRequest): string {
  ...
  return [
    ...
    "If the wine matches a favorite style or varietal, do not mention the preference directly unless it is paired with a more substantive reason, such as producer quality, value, style, age, scarcity, or fit with the list.",
    ...
    "Favor concrete reasons over preference boilerplate: producer reputation, vintage/age, scarcity, style, food versatility, category strength, value, or why this is a stronger choice than nearby alternatives on the same list.",
    "Do not over-focus on low price or savings. Treat value as quality-for-price, not cheapness.",
    "Assume the user is willing to spend for the right bottle, but wants to avoid overpaying for ordinary wine.",
    "When discussing price, frame it in terms of whether the wine earns its place on this list: producer quality, category pricing, vintage, scarcity, age, or a meaningfully better experience than nearby alternatives.",
